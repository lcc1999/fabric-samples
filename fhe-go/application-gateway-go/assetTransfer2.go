...
func main() {
	...
	replayChaincodeEvents(ctx, network, uint64(0), chaincodeName, contract)
...
func replayChaincodeEvents(ctx context.Context, network *client.Network, startBlock uint64, chaincodeName string, contract *client.Contract) {
